...
import { ArrowLeft, Zap, Calendar, DollarSign, Package, AlertCircle } from 'lucide-react'
    ...
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-2">
          Set up a time-limited flash sale for your products
        </p>
      </div>
                    ...
                    {products
                      ...
                      .map((product) => (
                        <SelectItem key={product.id} value={product.id}>
                          {product.name} (ETB {product.price} - {product.stockQuantity} in stock)
                        </SelectItem>
                      ))}
                  </SelectContent>
                </Select>
